...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [HYPER_LAYER] = KEYMAP(
    ...
    KC_LSFT,   KC_NO,             KC_NO,                 KC_NO,               KC_NO,      KC_NO, KC_1,    KC_2,    KC_3,    KC_NO,    KC_NO,    KC_RSFT,   KC_NO,                      \
    KC_LALT,   KC_LGUI,           KC_0,                  KC_NO,               KC_RALT                                                                                                  \
  ),
  ...
  [GIGA_LAYER] = KEYMAP(
    ...
    KC_LSHIFT, KC_NO,             KC_NO,                 KC_NO,               KC_NO,      KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_QUOTE, KC_RSHIFT, KC_NO,                      \
    KC_LALT,   KC_LGUI,           KC_NO,                 KC_NO,               KC_RALT                                                                                                  \
  ),
  ...
  [FUNCTION_LAYER] = KEYMAP(
    ...
    KC_LSHIFT, KC_NO,             KC_NO,                 KC_NO,               KC_NO,      KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,    KC_RSHIFT, KC_NO,                      \
    KC_LALT,   KC_LGUI,           KC_NO,                 KC_NO,               KC_RALT                                                                                                  \
  ),

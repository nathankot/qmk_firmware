...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [HYPER_LAYER] = KEYMAP(
    ...
    KC_LSFT,   KC_TRNS,           KC_TRNS,               KC_TRNS,             KC_TRNS,    KC_TRNS, KC_1,    KC_2,    KC_3,    KC_TRNS,  KC_TRNS,        KC_RSFT,           KC_TRNS,                             \
    KC_LALT,   KC_LGUI,           KC_0,                  KC_TRNS,             KC_RALT                                                                                                                           \
  ),
  ...
  [GIGA_LAYER] = KEYMAP(
    ...
    KC_LSHIFT, KC_TRNS,           KC_TRNS,               KC_TRNS,             KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_QUOTE, LSFT(KC_QUOTE), KC_RSHIFT,         KC_TRNS,                             \
    KC_LALT,   KC_LGUI,           KC_TRNS,               KC_TRNS,             KC_RALT                                                                                                                           \
  ),
  ...
  [FUNCTION_LAYER] = KEYMAP(
    ...
    KC_LSHIFT, KC_TRNS,           KC_TRNS,               KC_TRNS,             KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,        KC_RSHIFT,         KC_TRNS,                             \
    KC_LALT,   KC_LGUI,           KC_TRNS,               KC_TRNS,             KC_RALT                                                                                                                           \
  ),

  [F_ARROWS_LAYER] = KEYMAP(
    KC_TRNS,   KC_TRNS,           KC_TRNS,               KC_TRNS,             KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,        KC_TRNS,           KC_TRNS,           KC_TRNS, KC_TRNS, \
